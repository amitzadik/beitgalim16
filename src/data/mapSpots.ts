...
export const mapSpots: MapSpot[] = [
  ...
  { id: "oh-12", number: 12, kind: "open-house", title: "משפחת בלוקין", address: "העלייה השנייה 62, מתחת לבניין", x: 45.6, y: 64.6, events: ["בית פתוח"] },
  { id: "oh-13", number: 13, kind: "open-house", title: "בת-אל גולומבק", address: "נהלל 9", x: 59.1, y: 58.7, events: ["בית פתוח"] },
  { id: "oh-14", number: 14, kind: "open-house", title: "זאזא זהבה כהן", address: "שקמונה 4, מתחת לבניין", x: 36.6, y: 65.3, events: ["בית פתוח"] },
  { id: "oh-15", number: 15, kind: "open-house", title: "אנה פולונסקי, סופי מרטין שי ג'רסי, שחר ליאב, קרן דניס", address: "בית “האנג” שדרות בת גלים 12", x: 45.8, y: 57.1, events: ["בית פתוח"] },
  { id: "oh-16", number: 16, kind: "open-house", title: "טניה ואלכס מירון", address: "נחליאלי 5, קומת קרקע", x: 58.6, y: 37.9, events: ["בית פתוח"] },
  { id: "oh-17", number: 17, kind: "open-house", title: "לין תלם, קטיה ברונשטיין", address: "מרגולין 37", x: 38.2, y: 57.7, events: ["בית פתוח"] },
  { id: "oh-18", number: 18, kind: "open-house", title: "שירה בנגד, נתן גילה", address: "יונתן 9, חצר הבית", x: 53.4, y: 67.2, events: ["בית פתוח"] },
  ...
  { id: "oh-21", number: 21, kind: "open-house", title: "בוריס מוסקוביץ', דבורה פאר, יוליה קוזנצובה, אנדרי סופין", address: "רחף 2א, מתחת לבניין", x: 37.5, y: 76.5, events: ["בית פתוח"] },
  { id: "oh-22", number: 22, kind: "open-house", title: "שרי עוז", address: "לוז 10", x: 64.4, y: 55.1, events: ["בית פתוח"] },
  ...
  { id: "oh-26", number: 26, kind: "open-house", title: "אירית בונשטיין", address: "השרון 38, קומה 2", x: 42.4, y: 60.2, events: ["בית פתוח"] },
  { id: "oh-27", number: 27, kind: "open-house", title: "ישי ודינה קלי, סוניה בץ", address: "הקלעים 4", x: 39.8, y: 77.2, events: ["בית פתוח"] },
  { id: "oh-28", number: 28, kind: "open-house", title: "נוגה שלו, אלינה חבלב, הגר אזו\"ב", address: "השרון 25, פינת אבדימי", x: 55.3, y: 52.7, events: ["בית פתוח"] },
  { id: "oh-29", number: 29, kind: "open-house", title: "אורלי פרץ, קרן ויונתן", address: "שרל לוץ 4, קומה 3", x: 65.2, y: 44.4, events: ["בית פתוח"] },
  { id: "oh-30", number: 30, kind: "open-house", title: "אור מעוז והטריו, נתיבי הלב", address: "פינת גן 4", x: 32.5, y: 71.3, events: ["בית פתוח"] },
  { id: "oh-31", number: 31, kind: "open-house", title: "גבריאלה בונדר, עתליה קומורניק", address: "אבדימי 3, דירה 8", x: 54.7, y: 41.4, events: ["בית פתוח"] },
  ...
  { id: "oh-34", number: 34, kind: "open-house", title: "אלכס בן ארי", address: "החי\"ל 4, קומה 2", x: 58.4, y: 83.2, events: ["בית פתוח"] },
];
